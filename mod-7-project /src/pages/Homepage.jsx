    ...
    <main className="banner">
      <div className="slider" style={{ '--quantity': 7 }}>
        <div className="item" style={{ '--position': 1 }}>
          <img src="./images/heels.jpg" alt="Heels" />
        </div>
        <div className="item" style={{ '--position': 2 }}>
          <img src="./images/charzard2.png" alt="Charizard" />
        </div>
        <div className="item" style={{ '--position': 3 }}>
          <img src="./images/pikachu.jpg" alt="Pikachu" />
        </div>
        <div className="item" style={{ '--position': 4 }}>
          <img src="./images/found.jpg" alt="Umbreon" />
        </div>
        <div className="item" style={{ '--position': 5 }}>
          <img src="./images/squirt2.png" alt="Squirtle" />
        </div>
        <div className="item" style={{ '--position': 6 }}>
          <img src="./images/bulbasaur2.png" alt="Bulbasaur" />
        </div>
        <div className="item" style={{ '--position': 7 }}>
          <img src="./images/snorlax2.png" alt="Snorlax" />
        </div>
      </div>
